        ...
        if (isUnavailable) {
            return (
                ...
                >
                    ...
                    <p className="text-xs text-neutral-500 dark:text-neutral-400">This video was removed from the cache to save space.</p>
                     <button
    ...
    return (
        <div className="h-full flex flex-col">
            <div className="flex-shrink-0">
                ...
                <p className="text-neutral-500 dark:text-neutral-400 mt-1">Browse, download, or reuse all your generated content.</p>
            </div>
